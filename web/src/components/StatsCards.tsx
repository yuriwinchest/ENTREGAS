...
import { Users, CheckCircle2, Clock, Activity, TrendingUp } from "lucide-react";
    ...
    <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
      ...
      <div className="glass-card rounded-2xl p-4 sm:p-5 flex flex-col justify-between relative overflow-hidden group border-brand-500/20 bg-brand-950/10">
        ...
        <div className="mt-3 flex items-baseline justify-between">
          ...
          <span className="text-xs font-medium text-brand-400 flex items-center gap-0.5">
            <TrendingUp className="w-3.5 h-3.5" />
            Sincronizado
          </span>
        </div>
        <div className="absolute bottom-0 left-0 right-0 h-1 bg-gradient-to-r from-brand-600 to-amber-500" />
      </div>
